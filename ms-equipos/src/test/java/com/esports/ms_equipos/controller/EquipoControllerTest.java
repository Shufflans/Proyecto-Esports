...
public class EquipoControllerTest {
    ...
    void debeMostrarEquipos() throws Exception {
        EquipoResponse e1 = EquipoResponse.builder().id(1L).nombreEquipo("T1").region("LCK").activo(true).build();
        EquipoResponse e2 = EquipoResponse.builder().id(2L).nombreEquipo("G2").region("LEC").activo(true).build();
