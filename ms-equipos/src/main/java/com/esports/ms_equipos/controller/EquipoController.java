...
public class EquipoController {
        ...
        @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
        public ResponseEntity<ApiResponse<EquipoResponse>> agregarStaff(
                        @Parameter(description = "Debes ingresar la ID del Equipo al que deseas añadir el staff.", example = "1") @PathVariable Long id,
        ...
        @PreAuthorize("hasAnyRole('USER', 'ADMIN')")
        public ResponseEntity<ApiResponse<EquipoResponse>> agregarJugador(
                        @Parameter(description = "Debes ingresar la ID del Equipo al que deseas añadir al jugador.", example = "1") @PathVariable Long id,
        ...
        public ResponseEntity<ApiResponse<List<EquipoResponse>>> mostrarEquiposPorRegion(
                        @Parameter(description = "Debes ingresar la región del equipo que deseas buscar", example = "LATAM") @PathVariable String region) {
        ...
        public ResponseEntity<ApiResponse<EquipoResponse>> actualizarEquipo(
                        @Parameter(description = "Debes ingresar el ID del equipo que deseas Actualizar", example = "1") @PathVariable Long id,
        ...
        public ResponseEntity<ApiResponse<Void>> desactivarEquipo(
                        @Parameter(description = "Debes ingresar la ID del equipo que deseas desactivar", example = "1") @PathVariable Long id) {
        ...
        @PreAuthorize("hasRole('ADMIN')")
        public ResponseEntity<ApiResponse<Void>> terminarContrato(
                        @Parameter(description = "Debes ingresar la ID del jugador que deseas terminarle el contrato", example = "1") @PathVariable Long id) {
        ...
        @PreAuthorize("hasRole('ADMIN')")
        public ResponseEntity<ApiResponse<Void>> despedirStaff(
                        @Parameter(description = "Debes ingresar la ID del staff que deseas despedir", example = "1") @PathVariable Long id) {
