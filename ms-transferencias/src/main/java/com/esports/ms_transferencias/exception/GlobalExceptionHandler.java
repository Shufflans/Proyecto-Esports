...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleEquipoNoEncontrado(EquipoNoEncontradoException ex,
        ...
        log.warn("El equipo no existe: {} | URI: {}", ex.getMessage(), rq.getRequestURI());
    ...
    @ExceptionHandler(TipoDeTransferenciaInvalidoException.class)
    public ResponseEntity<ErrorResponse> handleTipoDeTransferenciaInvalido(TipoDeTransferenciaInvalidoException ex,
            HttpServletRequest rq) {
        log.warn("Tipo de transferencia inválido: {} | URI: {}", ex.getMessage(), rq.getRequestURI());
