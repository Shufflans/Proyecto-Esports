package com.esports.ms_rankings.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleRankingNoEncontrado(RankingNoEncontradoException ex,
            HttpServletRequest rq) {
        log.warn("Ranking no encontrado: {} | URI: {}", ex.getMessage(), rq.getRequestURI());
